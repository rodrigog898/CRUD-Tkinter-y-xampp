...
class Data:
	...
	def InsertItems(self, element):
		...
		#in position 0, 1, 2
		sql = "insert into reserva(id, nombre, rut, fecha_retiro, medicamentos) values('{}', '{}', '{}', '{}', '{}')".format(element[0],element[1],element[2],element[3],element[4])
		#execute the query
	...
	def ReturnOneItem(self, ref):
		...
		sql = "select * from reserva where id = '{}'".format(ref)
		self.cursor.execute(sql)
	...
	def Delete(self, ref):
		sql = "delete from reserva where id = '{}'".format(ref)
		self.cursor.execute(sql)
		self.conn.commit()
	...
	def UpdateItem(self, element, ref):
		...
		sql = "update reserva set id = '{}',nombre = '{}', rut='{}', fecha_retiro='{}', medicamentos='{}'where id = '{}'".format(element[0],element[1],element[2],element[3],element[4], ref)
		#execute the query
		self.cursor.execute(sql)
		self.conn.commit()#guardamos cambios
